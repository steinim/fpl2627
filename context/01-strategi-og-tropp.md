...
**Benk: Slater først, foran Davis og Diop — *revurdert og reversert 28. august, se under.*** ~~Anvendelse av Regel 7-overstyringen (se Operative regler): Gibbs-White har et tallfestet, stående skadeflagg (75 % sjanse for spill, uendret siden 25. august) og er eneste startende spiller med reell sannsynlighet for 0 minutter. Slater slår begge Ipswich-alternativene på både form (assist + 7 DefCon i GW1, høyest i troppen) og fikstur (Coventry borte — ligaens svakeste lag — mot Man Utd borte for Davis/Diop).~~

⚠️ **Revurdert 28. august, kveld — premisset er nå borte, og en ny risiko er sjekket og også lukket.**

Gibbs-White er bekreftet tilgjengelig (se lukket rad over). I tillegg fantes det en risiko denne filen ikke hadde fanget: **Neco Williams** (Forest, startende forsvarer) sto med et eget knock-flagg samme uke. Sports Mole og The Hard Tackle (begge 27. august, nivå 2) melder at **både** Gibbs-White og N.Williams «should be fit and available to take on Liverpool». Ingen kilde funnet på et tilsvarende flagg for Shaw — RotoWires GW2-laguttaksprojeksjon (27. august, nivå 3) fører ham i startoppstillingen uten forbehold.

**Konklusjon: ingen navngitt startspiller i treeren bak eller på midtbanen har et stående, tallfestet skadeflagg per i kveld.** Regel 7-overstyringens betingelse («en navngitt startspiller har et konkret, tallfestet skadeflagg») er dermed ikke lenger oppfylt for noen plassering, og defaulten trer tilbake i kraft: **forsvarere øverst på benken i en treer bak.**

**Ny benkerekkefølge: Davis, Diop, Slater** — reversert fra Slater først. Begrunnelsen er ikke at Slater er blitt svakere; den er at overstyringens navngitte grunnlag er borte, og defaulten i Regel 7 eksisterer nettopp fordi en benket forsvarer kan dekke et hull i alle tre posisjoner mens en benket midtbanespiller ikke kan dekke en manglende forsvarer i en treer bak. Formen og fiksturargumentet for Slater (assist + 7 DefCon, Coventry borte) er reelt, men var aldri sterkt nok til å slå defaulten alene — det var kombinasjonen med et navngitt flagg som gjorde det, jf. overstyringsklausulens egen ordlyd («ikke som ny generalregel»).

**Ikke lukket, og haster mer enn benkerekkefølgen:** linje 632 under noterer at Slaters egen startplass for Hull mot Coventry aldri ble bekreftet for GW2 — bare sjekket for GW1. Det er ikke gjort i denne økten heller. Sjekk dette **før** 18:30 BST i kveld; er Slater selv tvilsom, endrer det både benkerekkefølgen og om han i det hele tatt hører hjemme på benken foran Diop.

**Full GW2-benk: Verbruggen, Davis, Diop, Slater.** Davis/Diop-rekkefølgen seg imellom er **ikke** revurdert for GW2 — den står på GW1s regel 8-vurdering («nærkamp», Davis for offensive returer, Diop for DefCon), som ble satt for en annen kamp (Ipswich–Sunderland hjemme) enn GW2s faktiske (Man Utd borte, begge). Fordi begge nå møter samme motstander i samme kamp, mangler det et nytt skille å rangere dem på — «nærkamp»-logikken fra GW1 forutsatte at de kunne skilles på rolle i en gitt kamp, ikke at kampen selv er identisk for begge. Bør sjekkes på nytt før fredag hvis tid tillater det, men er ikke gjort i denne gjennomgangen.
