...
*Sist oppdatert: 28. august 2026 — Gibbs-White-skadeflagget lukket (Glasner bekreftet tilgjengelig, Yates tilbake, Sangaré ute, foran Liverpool-kampen). GW2-benkbegrunnelsen flagget for revurdering siden premisset for Slater-valget falt bort.*
...
⚠️ **Premisset falt bort 28. august.** Gibbs-White er bekreftet tilgjengelig (se lukket rad over) — «eneste startende spiller med reell sannsynlighet for 0 minutter» stemmer ikke lenger, og Regel 7-overstyringen mister sitt navngitte grunnlag for **denne** plasseringen. Det betyr ikke automatisk at Slater skal ut av topp-benkplassen — form- og fiksturargumentet (assist + 7 DefCon, Coventry borte) står fortsatt uavhengig av skadeflagget — men konklusjonen er ikke lenger reverifisert mot riktig premiss før GW2-fristen i dag. **Ikke revurdert i denne økten.**
