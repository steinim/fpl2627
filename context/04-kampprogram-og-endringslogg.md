...
| Sjekkpunkt | Funn |
|---|---|
| Flyttede kamper i GW1–3 | Alle TV-flyttinger er kunngjort 7. juli og allerede innbakt i listen under |
| Utsatte kamper | **Ingen** |
| Bekreftet blankrunde (BGW) | **Ingen** |
| Bekreftet dobbeltrunde (DGW) | **Ingen** |
| Nyeste offisielle kunngjøring | 17. august 2026 — gjelder GW6–9, ingen endring for GW1–3 |
...
## Betingede endringer — ikke avgjort

| Kamp | Runde | Står nå | Flyttes til hvis | Utløser |
|---|---|---|---|---|
| Leeds – Newcastle | GW4 | man 14.9. 20:00 | lør 12.9. 12:30 | Enten klubb i Ligacup 3. runde mot CL-deltaker |
| Brentford – Chelsea | GW5 | fre 18.9. 20:00 | lør 19.9. 20:00 | Samme |
| Aston Villa – Man City | GW8 | lør 24.10. 12:30 | lør 24.10. 20:00 | Villa trukket bortekamp i CL påfølgende onsdag |

Ingen av dem flytter en kamp ut av sin runde — de er derfor uten poengkonsekvens. **Men Brentford–Chelsea er GW5s eneste fredagskamp:** flyttes den til lørdag, forskyves GW5-deadlinen fra fredag 18. september til lørdag 19. september.
...
**Ikke verifisert:** premierleague.com/en/fixtures lastes ikke uten JavaScript, så kampdatabasen er ikke lest direkte per i dag. Verifiseringen bygger på PLs egne artikler, inkludert den ferskeste fra 17. august. 15:00-kampene uten TV-dekning er utledet av PLs standardregel («all kick-off times are 15:00 BST unless otherwise mentioned»), ikke av eksplisitt oppføring per kamp — med unntak av Man City–Coventry, som mancity.com bekrefter direkte.
