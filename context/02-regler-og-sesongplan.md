...
### GW3-utfallet — ført inn 7. september, rankdelen rettet 8. september
...
⚠️ **Rettet 8. september: det var ingen pris i rank.** OR gikk fra 669 925 til **638 377** — en forbedring på 31 548 plasser i runden med 2,9 millioner chipbruk. Det tidligere tallet 850 111 ble lest fra appen mens runden fortsatt var ulåst, og hele avsnittet som sto her hvilte på det. Se `01` og feilloggen i `03`.
...
**Åpent punkt til GW4-kontrollposten — feltets chipbruk som variabel: svekket, ikke bortfalt.** Planen over veier fikstur og europakalender. Den veier ikke **når resten av feltet bruker sine chips.** Punktet ble ført 7. september på observasjonen at GW3 kostet 180 186 plasser; **den observasjonen er feil.** Igjen står en strukturell hypotese uten datapunkt: chipbruk er konsentrert blant engasjerte managere, og de ligger nærmere vår egen plassering enn feltet ellers. ⚠️ **GW3 er nå et motargument** — maksimal chipbruk i feltet, ingen målbar rankskade for oss. **Tas stilling til 14. september: hypotesen skal begrunnes på nytt eller forkastes, ikke videreføres på gammelt grunnlag.**

**Reserven i TC-raden er utløpt.** «Reserve GW3» er passert. Faller GW5-premisset i kontrollposten, står kun GW7 og GW13 igjen — begge dårligere enn GW3 var, slik seksjonen «Det som ikke lenger er tilgjengelig» allerede sier. Prisen for å vente er **9 poeng** mot dem som spilte TC i GW3, ikke en rankkostnad. Den er reell, men mindre enn ført 7. september.
...
| Haalands minutter mot Norwich | Handling før deadline fredag |
|---|---|
| Ubrukt eller under 30 | GW5 styrket. Chipen bekreftes |
| 30–59 | Nøytralt. Beslutningen fra 14. september står |
| 60+ | **Stopp.** 66,5 timers snuoperasjon til søndag 14:00 med City uten reservenier. Sammenlign GW5 mot GW7 eksplisitt på nytt før fredag 18:30 |
